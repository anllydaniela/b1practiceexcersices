...
contexto.fillText("TIME:",8,15);contexto.lineWidth = 5;contexto.stroke();var radius = 25;
...
contexto.font="8px Verdana";contexto.textAlign = "left";contexto.fillText("SUCCESSES:",8,profundidade+14);contexto.lineWidth = 5;contexto.stroke();
...
contexto.fillText("ATTEMPTS:",8,profundidade+14);contexto.lineWidth = 5;contexto.stroke();contexto.beginPath();contexto.font="bold 14px Verdana";
...
contexto.fillText("POINTS:",8,profundidade+14);contexto.lineWidth = 5;contexto.stroke();contexto.beginPath();contexto.fillStyle =colorBack;
